...
if (strlen($_SESSION['aid']==0)) {
    ...
    if(isset($_POST['submit']))
  {
   ...
   $sid=$_GET['editid'];
       $query=mysqli_query($con, "update category set vehcat= '$catname',cost='$cost' where id='$sid' ");
    if ($query) {
...
<html>
<head>
<title>Online Toll Plaza System || Update Category</title>
...
?>
          <fieldset>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched"  required="true" id="catname" name="catname" value="<?php  echo $row['vehcat'];?>">
            </div>
