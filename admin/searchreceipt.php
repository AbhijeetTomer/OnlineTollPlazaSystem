...
<html>
<head>
<title>Online Toll Plaza System || Search Receipt</title>
 ...
 <form class="form-floating ng-pristine ng-invalid ng-invalid-required ng-valid-email ng-valid-url ng-valid-pattern" method="post">
  <fieldset>
            ...
            <div class="form-group">
              <label class="control-label">Search by Receipt Number/ Vehicle Number / Owner Name</label>
...
$sdata=$_POST['searchdata'];
  ...
  <h4 align="center">Result against "<?php echo $sdata;?>" keyword </h4> 
      <table class="table table-bordered">
        ...
        <tbody>
           <?php
$ret=mysqli_query($con,"select * from receipt where id like '%$sdata%' || vehno like '%$sdata%' || name like '%$sdata%'");
