...
<html lang="en">
<head>
<title>Online Toll Plaza System ||Admin Page</title>
...
<div id="page-wrapper">
			<div id="modal-wrapper">
				<div id="modal">
					<div id="cards">
						<div class="card" id="login">
							<div class="box">
								<b style="color:white; font-family:oswald;">ADMIN LOGIN</b>
							</div>
							<form class="login-form" method="post" action="l1.php">
								<label >Username
								</label>
								<input type="text" id="login-email" name="name" class="textbox" required />
								<label
									>Password
								</label>
                ...
                <span><a style="text-decoration:none; margin-left:8.5%;" href="../user/register.php"><strong style = "color: white;">User Login</strong></a>	</span><br> <br>
			</div>
		</div>
