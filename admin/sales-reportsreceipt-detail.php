...
<th>Sales</th>
        ...
        <tbody>
           <?php
$ret=mysqli_query($con,"select month(valfrom) as lmonth,year(valfrom) as lyear,sum(cost) as totalprice from receipt where date(valfrom) between '$fdate' and '$tdate' group by lmonth,lyear");
$cnt=1;
...
<th>Sales</th>
        ...
        <tbody>
           <?php
$ret=mysqli_query($con,"select year(creationdate) as lyear,sum(cost) as totalprice from receipt where year(creationdate) between '$fdate' and '$tdate' group by lyear");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
